    ...
    <section id="about" className="section">
      <div className="container about-grid">
        <div className="section-heading">
          ...
          <h2>Dedicated engineer with a product-minded approach</h2>
        </div>

        <div className="about-card">
          <p>
            I am a dedicated Computer Engineering student with hands-on experience in
            software development, web technologies, AI-driven applications, and
